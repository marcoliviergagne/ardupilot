...
static int AP_MotorsMatrix_6DoF_Scripting_add_motor(lua_State *L) {
    ...
    luaL_argcheck(L, ((raw_data_4 >= MAX(-FLT_MAX, -INFINITY)) && (raw_data_4 <= MIN(FLT_MAX, INFINITY))), 4, "argument out of range");
    const float data_4 = raw_data_4;
    const float raw_data_5 = luaL_checknumber(L, 5);
    luaL_argcheck(L, ((raw_data_5 >= MAX(-FLT_MAX, -INFINITY)) && (raw_data_5 <= MIN(FLT_MAX, INFINITY))), 5, "argument out of range");
    const float data_5 = raw_data_5;
    const float raw_data_6 = luaL_checknumber(L, 6);
    luaL_argcheck(L, ((raw_data_6 >= MAX(-FLT_MAX, -INFINITY)) && (raw_data_6 <= MIN(FLT_MAX, INFINITY))), 6, "argument out of range");
    const float data_6 = raw_data_6;
    const float raw_data_7 = luaL_checknumber(L, 7);
    luaL_argcheck(L, ((raw_data_7 >= MAX(-FLT_MAX, -INFINITY)) && (raw_data_7 <= MIN(FLT_MAX, INFINITY))), 7, "argument out of range");
    const float data_7 = raw_data_7;
    const float raw_data_8 = luaL_checknumber(L, 8);
    luaL_argcheck(L, ((raw_data_8 >= MAX(-FLT_MAX, -INFINITY)) && (raw_data_8 <= MIN(FLT_MAX, INFINITY))), 8, "argument out of range");
    ...
    luaL_argcheck(L, ((raw_data_10 >= MAX(0, 0)) && (raw_data_10 <= MIN((AP_MOTORS_MAX_NUM_MOTORS-1), UINT8_MAX))), 10, "argument out of range");
...
static int AP_MotorsMatrix_add_motor_raw(lua_State *L) {
    ...
    luaL_argcheck(L, ((raw_data_6 >= MAX(0, 0)) && (raw_data_6 <= MIN((AP_MOTORS_MAX_NUM_MOTORS-1), UINT8_MAX))), 6, "argument out of range");
